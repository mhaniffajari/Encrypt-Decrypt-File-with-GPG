...
def generate_key():
    input_data = gpg.gen_key_input(name_email="user@example.com", passphrase="your-passphrase")
    key = gpg.gen_key(input_data)
    
    # Export the private and public keys
    public_key = gpg.export_keys(key.fingerprint)
    private_key = gpg.export_keys(key.fingerprint, secret=True, passphrase="your-passphrase")
